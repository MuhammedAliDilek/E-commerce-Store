...
export default function Search(props) {
  ...
  searchedData = query
    ? data.products.filter((datum) => {
        return (
          datum.name.toLowerCase().includes(query.toLowerCase()) ||
          datum.brand.toLowerCase().includes(query.toLowerCase()) ||
          datum.category.toLowerCase().includes(query.toLowerCase())
        );
      })
    : data.products;
  ...
  // date icin ise new Date(a.date) - new Date(b.date)
  // featured icin no action should be more than enough which is the default order of your data.
  let sortedData;
  if (sort === "featured") {
